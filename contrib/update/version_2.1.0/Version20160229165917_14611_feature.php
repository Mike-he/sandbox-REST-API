...
class Version20160229165917_14611_feature extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO SalesAdminPermission(`typeId`,`key`,`name`,`creationDate`,`modificationDate`) VALUES(2,'sales.building.order.preorder','订单预订','2016-03-01 00:00:00','2016-03-01 00:00:00')");
