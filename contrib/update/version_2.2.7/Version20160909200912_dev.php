 ...
 */
class Version20160909200912_dev extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            ...
            VALUES(2,'platform.order','订单管理','2015-08-24 00:00:00','2015-08-24 00:00:00'),
                  ...
                  (2,'platform.bulletin','公告管理','2015-08-24 00:00:00','2015-08-24 00:00:00'),
        ...
        $this->addSql("
            ...
            VALUES(1,'http://devimage.sandbox3.cn/advertising/1326x1080_coffee_ad.jpg','image/png','1326x1080_coffee_ad.jpg','http://devimage.sandbox3.cn/advertising/1326x1080_coffee_ad.jpg',3,1326,1080),
                  (1,'http://devimage.sandbox3.cn/advertising/1416x1080_coffee_ad.jpg','image/png','1416x1080_coffee_ad.jpg','http://devimage.sandbox3.cn/advertising/1416x1080_coffee_ad.jpg',3,1416,1080),
                  (1,'http://devimage.sandbox3.cn/advertising/1486x1080_coffee_ad.jpg','image/png','1486x1080_coffee_ad.jpg','http://devimage.sandbox3.cn/advertising/1486x1080_coffee_ad.jpg',3,1486,1080),
                  (1,'http://devimage.sandbox3.cn/advertising/1556x1080_coffee_ad.jpg','image/png','1556x1080_coffee_ad.jpg','http://devimage.sandbox3.cn/advertising/1556x1080_coffee_ad.jpg',3,1556,1080);
        ");
        ...
        $this->addSql("
            ...
            VALUES('free_wifi', 'http://devimage.sandbox3.cn/icon/building_service_free_wifi.png'),
                  ('printing_devices', 'http://devimage.sandbox3.cn/icon/building_service_print_device.png'),
                  ('tea', 'http://devimage.sandbox3.cn/icon/building_service_tea.png'),
                  ('coffee', 'http://devimage.sandbox3.cn/icon/building_service_coffee.png'),
                  ('enterprise_incubation', 'http://devimage.sandbox3.cn/icon/building_service_enterprise_incubation.png'),
                  ('register_agent', 'http://devimage.sandbox3.cn/icon/building_service_register_agent.png'),
                  ('cleaning', 'http://devimage.sandbox3.cn/icon/building_service_cleaning.png'),
                  ('telephone_booth', 'http://devimage.sandbox3.cn/icon/building_service_telephone_booth.png'),
                  ('meeting_service', 'http://devimage.sandbox3.cn/icon/building_service_meeting_service.png'),
                  ('community_manager', 'http://devimage.sandbox3.cn/icon/building_service_community_manager.png'),
                  ('enterprise_service', 'http://devimage.sandbox3.cn/icon/building_service_enterprise_service.png');
        ");

        $this->addSql("
            INSERT INTO `room_building_tag` (`key`, `icon`)
            VALUES('sandbox3_manage', 'http://devimage.sandbox3.cn/icon/building_tag_sandbox_manage.png'),
                  ('round_the_clock_service', 'http://devimage.sandbox3.cn/icon/building_tag_7*24.png'),
                  ('certification_of_incubator', 'http://devimage.sandbox3.cn/icon/building_tag_auth_incubator.png'),
                  ('food_and_beverage', 'http://devimage.sandbox3.cn/icon/building_tag_food.png'),
                  ('vip_space', 'http://devimage.sandbox3.cn/icon/building_tag_vip_space.png'),
                  ('fast_preorder', 'http://devimage.sandbox3.cn/icon/building_tag_fast_preorder.png');
        ");
        ...
        $this->addSql("
            ...
            VALUES('office', 'http://devimage.sandbox3.cn/icon/room_type_office.png'),
                  ('meeting', 'http://devimage.sandbox3.cn/icon/room_type_meeting.png'),
                  ('flexible', 'http://devimage.sandbox3.cn/icon/room_type_flexible.png'),
                  ('fixed', 'http://devimage.sandbox3.cn/icon/room_type_fixed.png'),
                  ('studio', 'http://devimage.sandbox3.cn/icon/room_type_studio.png'),
                  ('space', 'http://devimage.sandbox3.cn/icon/room_type_space.png');
        ");
        ...
        $this->addSql("
            ...
            VALUES ('sales', '2', 'http://devimage.sandbox3.cn/user_card/sandbox3_user_card.png', 'http://devimage.sandbox3.cn/user_card/sandbox3_user_card_bg.png', '#e8d47c', '2016-07-06 15:27:00', '2016-07-06 15:27:00', 'http://devimage.sandbox3.cn/user_card/sandbox3_user_card_lost_bg.png');
        ...
        $this->addSql("
            ...
            VALUES(1,'food','web','https://testcoffee.sandbox3.cn/',1,'sandbox'),
                  (2,'print','web','https://testprint.sandbox3.cn/',0,'sandbox'),
                  (3,'coffee','web','https://testcoffee.sandbox3.cn/',1,'sandbox'),
                  (4,'forward','web','https://testcafe.sandbox3.cn',1,'sandbox'),
                  (5,'news','web','https://testm.sandbox3.cn/news',1,'sandbox'),
                  (6,'event','web','https://testm.sandbox3.cn/event',1,'sandbox'),
                  (7,'reservation','web','https://testmobile.sandbox3.cn/search',1,'sandbox'),
                  (8,'invoice','web','https://testinvoice.sandbox3.cn/invoice',1,'sandbox'),
                  (9,'about','web','https://testmobile.sandbox3.cn/about-xiehe',1,'xiehe'),
                  (10,'reservation','web','https://testmobile.sandbox3.cn/search-xiehe',1,'xiehe');
        ");

        $this->addSql("
            INSERT INTO `menu` (`component`, `platform`, `minVersion`, `maxVersion`, `mainJson`, `profileJson`, `homeJson`) 
            VALUES('client', 'iphone', '2.2.4', '2.2.7', '[{\"type\":\"icons\",\"items\":[{\"key\":\"order\",\"type\":\"web\",\"name\":\"client.menu.order\",\"web\":{\"url\":\"https://testtestmobile.sandbox3.cn/search\",\"cookie\":[{\"key\":\"btype\",\"value\":\"recommend\"}]},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_booking.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"coffee\",\"type\":\"web\",\"name\":\"client.menu.coffee\",\"web\":{\"url\":\"https://testcoffee.sandbox3.cn\"},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_coffee.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"event\",\"type\":\"web\",\"name\":\"client.menu.event\",\"web\":{\"url\":\"https://testm.sandbox3.cn/event\",\"cookie\":[{\"key\":\"btype\",\"value\":\"all\"}]},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_events.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"location\",\"type\":\"app\",\"name\":\"client.menu.location\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_locations.png\",\"status\":\"active\",\"login_need\":false}]},{\"type\":\"list\",\"items\":[{\"key\":\"community\",\"type\":\"app\",\"name\":\"client.menu.community\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_home.png\",\"status\":\"active\",\"login_need\":false}]},{\"type\":\"list\",\"items\":[{\"key\":\"feed\",\"type\":\"app\",\"name\":\"client.menu.blog\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_posts.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"message\",\"type\":\"app\",\"name\":\"client.menu.message\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_chat.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"contact\",\"type\":\"app\",\"name\":\"client.menu.contact\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_contacts.png\",\"status\":\"active\",\"login_need\":false}]},{\"type\":\"list\",\"items\":[{\"key\":\"member\",\"type\":\"app\",\"name\":\"client.menu.member\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_members.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"company\",\"type\":\"app\",\"name\":\"client.menu.company\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_companies.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"my_company\",\"type\":\"app\",\"name\":\"client.menu.my_company\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_my_companies.png\",\"status\":\"active\",\"login_need\":true}]}]', '[{\"type\":\"list\",\"menus\":[[{\"key\":\"topup\",\"type\":\"web\",\"name\":\"client.menu.balance\",\"web_url\":{\"url\":\"https://testmobile.sandbox3.cn/recharge\"},\"status\":\"active\",\"login_need\":true}],[{\"key\":\"my_order\",\"type\":\"app\",\"name\":\"client.menu.my_order\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_my_orders.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"my_room\",\"type\":\"app\",\"name\":\"client.menu.my_room\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_used_rooms.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"announcement\",\"type\":\"app\",\"name\":\"client.menu.notification\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_chat.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"my_invoice\",\"type\":\"web\",\"name\":\"client.menu.my_invoice\",\"web\":{\"url\":\"http://10.0.2.84:9000/invoice\"},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_invoice.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"member_card\",\"type\":\"app\",\"name\":\"client.menu.membership_card\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_card.png\",\"status\":\"active\",\"login_need\":true}],[{\"key\":\"reset_password\",\"type\":\"app\",\"name\":\"client.menu.reset_password\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_password.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"email\",\"type\":\"app\",\"name\":\"client.menu.email\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_mail.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"phone\",\"type\":\"app\",\"name\":\"client.menu.phone\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_phone.png\",\"status\":\"active\",\"login_need\":true}],[{\"key\":\"about_us\",\"type\":\"web\",\"name\":\"client.menu.about_us\",\"web\":{\"url\":\"https://testmobile.sandbox3.cn/about?version=2.2.4\"},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_about_sandbox.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"setting\",\"type\":\"app\",\"name\":\"client.menu.setting\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_settings.png\",\"status\":\"active\",\"login_need\":true}]]}]', '[{\"type\":\"bannerCarousel\",\"hidden_asserts\":[{\"item_key\":\"banner\",\"limit\":5,\"offset\":1}],\"items\":[]},{\"type\":\"icons\",\"hidden_asserts\":[{\"item_key\":\"room_types\",\"limit\":10,\"offset\":1}],\"items\":[]},{\"type\":\"banner\",\"hidden_asserts\":[{\"item_key\":\"banner\",\"limit\":100,\"offset\":1}],\"items\":[]}]'),
                  ('client', 'android', '2.2.4', '2.2.7', '[{\"type\":\"icons\",\"items\":[{\"key\":\"order\",\"type\":\"web\",\"name\":\"client.menu.order\",\"web\":{\"url\":\"https://testmobile.sandbox3.cn/search\",\"cookie\":[{\"key\":\"btype\",\"value\":\"recommend\"}]},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_booking.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"coffee\",\"type\":\"web\",\"name\":\"client.menu.coffee\",\"web\":{\"url\":\"https://testcoffee.sandbox3.cn\"},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_coffee.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"event\",\"type\":\"web\",\"name\":\"client.menu.event\",\"web\":{\"url\":\"https://testm.sandbox3.cn/event\",\"cookie\":[{\"key\":\"btype\",\"value\":\"all\"}]},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_events.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"location\",\"type\":\"app\",\"name\":\"client.menu.location\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_locations.png\",\"status\":\"active\",\"login_need\":false}]},{\"type\":\"list\",\"items\":[{\"key\":\"community\",\"type\":\"app\",\"name\":\"client.menu.community\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_home.png\",\"status\":\"active\",\"login_need\":false}]},{\"type\":\"list\",\"items\":[{\"key\":\"feed\",\"type\":\"app\",\"name\":\"client.menu.blog\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_posts.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"message\",\"type\":\"app\",\"name\":\"client.menu.message\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_chat.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"contact\",\"type\":\"app\",\"name\":\"client.menu.contact\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_contacts.png\",\"status\":\"active\",\"login_need\":false}]},{\"type\":\"list\",\"items\":[{\"key\":\"member\",\"type\":\"app\",\"name\":\"client.menu.member\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_members.png\",\"status\":\"active\",\"login_need\":false},{\"key\":\"company\",\"type\":\"app\",\"name\":\"client.menu.company\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_companies.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"my_company\",\"type\":\"app\",\"name\":\"client.menu.my_company\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v225/ic_my_companies.png\",\"status\":\"active\",\"login_need\":true}]}]', '[{\"type\":\"list\",\"menus\":[[{\"key\":\"topup\",\"type\":\"web\",\"name\":\"client.menu.balance\",\"web_url\":{\"url\":\"https://testmobile.sandbox3.cn/recharge\"},\"status\":\"active\",\"login_need\":true}],[{\"key\":\"my_order\",\"type\":\"app\",\"name\":\"client.menu.my_order\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_my_orders.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"my_room\",\"type\":\"app\",\"name\":\"client.menu.my_room\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_used_rooms.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"announcement\",\"type\":\"app\",\"name\":\"client.menu.notification\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_chat.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"my_invoice\",\"type\":\"web\",\"name\":\"client.menu.my_invoice\",\"web\":{\"url\":\"https://testtestinvoice.sandbox3.cn/invoice\"},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_invoice.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"member_card\",\"type\":\"app\",\"name\":\"client.menu.membership_card\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_card.png\",\"status\":\"active\",\"login_need\":true}],[{\"key\":\"reset_password\",\"type\":\"app\",\"name\":\"client.menu.reset_password\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_password.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"email\",\"type\":\"app\",\"name\":\"client.menu.email\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_mail.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"phone\",\"type\":\"app\",\"name\":\"client.menu.phone\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_acc_phone.png\",\"status\":\"active\",\"login_need\":true}],[{\"key\":\"about_us\",\"type\":\"web\",\"name\":\"client.menu.about_us\",\"web\":{\"url\":\"https://testmobile.sandbox3.cn/about?version=2.2.4\"},\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_about_sandbox.png\",\"status\":\"active\",\"login_need\":true},{\"key\":\"setting\",\"type\":\"app\",\"name\":\"client.menu.setting\",\"icon_url\":\"http://devimage.sandbox3.cn/menu/client/v224/ic_settings.png\",\"status\":\"active\",\"login_need\":true}]]}]', '[{\"type\":\"bannerCarousel\",\"hidden_asserts\":[{\"item_key\":\"banner\",\"limit\":5,\"offset\":1}],\"items\":[]},{\"type\":\"icons\",\"hidden_asserts\":[{\"item_key\":\"room_types\",\"limit\":10,\"offset\":1}],\"items\":[]},{\"type\":\"banner\",\"hidden_asserts\":[{\"item_key\":\"banner\",\"limit\":100,\"offset\":1}],\"items\":[]}]');
        ");
        ...
        $this->addSql("
            ...
            VALUES('room_order', 'http://devimage.sandbox3.cn/icon/profile_orders_room_order.png', 'https://testorders.sandbox3.cn/room'),
                  ('shop_order', 'http://devimage.sandbox3.cn/icon/profile_orders_shop_order.png', 'https://testorders.sandbox3.cn/shop'),
                  ('event_order', 'http://devimage.sandbox3.cn/icon/profile_orders_event_order.png', 'https://testorders.sandbox3.cn/event');
        ");
