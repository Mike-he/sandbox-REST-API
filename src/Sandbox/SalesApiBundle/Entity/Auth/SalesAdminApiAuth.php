...
namespace Sandbox\SalesApiBundle\Entity\Auth;
 ...
 *
 * @ORM\Table(
 *      name="sales_admin_api_auth_view",
...
class SalesAdminApiAuth implements UserInterface
{
     ...
     * @var SalesAdmin
     *
     * @ORM\OneToOne(targetEntity="Sandbox\ApiBundle\Entity\SalesAdmin\SalesAdmin"))
    ...
    public function getRoles()
    {
        return array('ROLE_SALES_ADMIN_API');
    }
