...
class SalesCompanyWithdrawals
{
     ...
     * @Serializer\Groups({"main", "admin_detail", "sales_list", "official_list"})
     */
    private $id;
     ...
     * @Serializer\Groups({"main", "admin_detail", "official_list"})
     */
