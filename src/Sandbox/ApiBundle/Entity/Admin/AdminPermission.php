...
class AdminPermission
{
    ...
    const KEY_SALES_PLATFORM_SERVICE_ORDER = 'sales.platform.service_order';

    // Sales Building Permission
    ...
    const KEY_COMMNUE_PLATFORM_COMPANY = 'commue.platform.company';
