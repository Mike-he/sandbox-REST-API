 ...
 *
 * @ORM\Table(
 *     name="shop_order_product_spec",
 *     uniqueConstraints={
 *      @ORM\UniqueConstraint(name="specId_productId", columns={"specId", "productId"})
 *     }
 * )
 * @ORM\Entity
 */
class ShopOrderProductSpec
{
     ...
     * @ORM\JoinColumn(name="specId", referencedColumnName="id", onDelete="SET NULL")
     * @Serializer\Groups({"main"})
     */
    private $spec;
