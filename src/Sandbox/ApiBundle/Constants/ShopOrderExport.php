...
class ShopOrderExport
{
    ...
    const TRANS_SHOP_ORDER_HEADER_STATUS = 'shop_order.export_header.status';
    const TRANS_SHOP_ORDER_HEADER_CHANNEL = 'shop_order.export_header.channel';
}
