...
class LoadAdminPermissionGroupData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $this->addReference('official-group-dashboard', $officialGroupDashboard);
        ...
        $this->addReference('official-group-banner', $officialBanner);
        ...
        $this->addReference('official-group-news', $officialGroupNews);
