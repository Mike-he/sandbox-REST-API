...
# Install tools
RUN apt-get install -y vim cron wget nginx php5-fpm php5-mysql php5-curl php5-common php5-redis php5-gd libxrender1 libxtst6 fonts-wqy-zenhei php5-mcrypt \
