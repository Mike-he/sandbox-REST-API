 ...
 */
class Version20151119020315_bug_13691 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Feed ADD isDeleted TINYINT(1) DEFAULT FALSE NOT NULL, DROP visible');
