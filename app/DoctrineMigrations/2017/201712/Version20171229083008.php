...
class Version20171229083008 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE expert (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(64) NOT NULL, gender VARCHAR(16) NOT NULL, credential_no VARCHAR(64) NOT NULL, phone VARCHAR(64) NOT NULL, email VARCHAR(128) DEFAULT NULL, country_id INT DEFAULT NULL, city_id INT DEFAULT NULL, province_id INT DEFAULT NULL, district_id INT DEFAULT NULL, base_price DOUBLE PRECISION DEFAULT NULL, is_service TINYINT(1) NOT NULL, banned TINYINT(1) NOT NULL, identity VARCHAR(64) DEFAULT NULL, introduction VARCHAR(256) DEFAULT NULL, description LONGTEXT DEFAULT NULL, photo LONGTEXT DEFAULT NULL, creation_date DATETIME DEFAULT NULL, modification_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
