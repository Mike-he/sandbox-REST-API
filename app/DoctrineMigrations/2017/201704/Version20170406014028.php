 ...
 */
class Version20170406014028 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DELETE FROM membership_order');
        ...
        $this->addSql('CREATE TABLE user_group_doors (id INT AUTO_INCREMENT NOT NULL, group_id INT DEFAULT NULL, card_id INT DEFAULT NULL, building_id INT NOT NULL, door_control_id VARCHAR(255) DEFAULT NULL, name VARCHAR(64) NOT NULL, creationDate DATETIME NOT NULL, INDEX IDX_A76C94D8FE54D947 (group_id), INDEX IDX_A76C94D84ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_group_doors ADD CONSTRAINT FK_A76C94D84ACC9A20 FOREIGN KEY (card_id) REFERENCES membership_card (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_group_doors DROP FOREIGN KEY FK_A76C94D84ACC9A20');
