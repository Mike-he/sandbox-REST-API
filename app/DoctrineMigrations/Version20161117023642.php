...
class Version20161117023642 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("UPDATE `admin_permission` SET `parentId`='49' WHERE `key` IN ('sales.building.order.reserve','sales.building.order.preorder','sales.building.room','sales.building.building','sales.building.product')");
    }
