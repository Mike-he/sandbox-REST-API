 ...
 */
class Version920170523052850 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        $menuIphone->setMinVersion('2.7.0');
        $menuIphone->setMaxVersion('2.7.99');
        ...
        $menuAndroid->setMinVersion('2.7.0');
        $menuAndroid->setMaxVersion('2.7.99');
