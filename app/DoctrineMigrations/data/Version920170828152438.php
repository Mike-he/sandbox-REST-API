 ...
 */
class Version920170828152438 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        $invoices = $em->getRepository('SandboxApiBundle:Finance\FinanceShortRentInvoice')->findAll();
