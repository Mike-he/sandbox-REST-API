 ...
 */
class Version920170420095211 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        $menuIphone->setMinVersion('2.6.0');
        $menuIphone->setMaxVersion('2.6.99');
        ...
        $menuAndroid->setMinVersion('2.6.0');
        $menuAndroid->setMaxVersion('2.6.99');
