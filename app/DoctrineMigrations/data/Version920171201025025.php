 ...
 */
class Version920171201025025 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        $menuIphone->setMinVersion('3.1.0');
        $menuIphone->setMaxVersion('3.1.99');
        ...
        $menuAndroid->setMinVersion('3.1.0');
        $menuAndroid->setMaxVersion('3.1.99');
