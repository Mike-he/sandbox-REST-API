 ...
 */
class Version920170410095211 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        $menuIphone->setMinVersion('2.5.0');
        $menuIphone->setMaxVersion('2.5.99');
        ...
        $menuAndroid->setMinVersion('2.5.0');
        $menuAndroid->setMaxVersion('2.5.99');
