 ...
 */
class Version920170510064256 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        foreach ($version26x as $version) {
            $version->setMainJson($mainJson);
            $version->setProfileJson($profileJson);
            $version->setHomeJson($homeJson);
        }
