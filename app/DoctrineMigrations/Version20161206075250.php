 ...
 */
class Version20161206075250 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE lease_bill (id INT AUTO_INCREMENT NOT NULL, lease_id INT DEFAULT NULL, serial_number VARCHAR(50) DEFAULT NULL, name VARCHAR(40) DEFAULT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, creation_date DATETIME DEFAULT NULL, modification_date DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, amount NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(15) DEFAULT NULL, type VARCHAR(10) DEFAULT NULL, revised_amount NUMERIC(10, 2) DEFAULT NULL, revision_note VARCHAR(225) DEFAULT NULL, INDEX IDX_467B22FCD3CA542C (lease_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lease_rent_types (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(16) NOT NULL, name_en VARCHAR(16) NOT NULL, status VARCHAR(15) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE lease_bill ADD CONSTRAINT FK_467B22FCD3CA542C FOREIGN KEY (lease_id) REFERENCES leases (id) ON DELETE SET NULL');
