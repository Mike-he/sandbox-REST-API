 ...
 */
class Version20170405080212 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE membership_card_specification (id INT AUTO_INCREMENT NOT NULL, card_id INT DEFAULT NULL, specification VARCHAR(64) NOT NULL, price NUMERIC(10, 2) NOT NULL, valid_period INT NOT NULL, creation_date DATETIME NOT NULL, modification_date DATETIME NOT NULL, INDEX IDX_525FD2BB4ACC9A20 (card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE membership_order ADD card_id INT DEFAULT NULL, ADD order_number VARCHAR(64) NOT NULL, ADD user_id INT NOT NULL, ADD valid_period INT NOT NULL, ADD specification VARCHAR(64) NOT NULL, ADD status VARCHAR(64) NOT NULL, ADD pay_channel VARCHAR(16) DEFAULT NULL, ADD payment_date DATETIME DEFAULT NULL, ADD cancelled_date DATETIME DEFAULT NULL, ADD invoiced TINYINT(1) DEFAULT \'0\' NOT NULL, ADD sales_invoice TINYINT(1) DEFAULT \'0\' NOT NULL, ADD service_fee DOUBLE PRECISION DEFAULT \'0\' NOT NULL, ADD creation_date DATETIME NOT NULL, ADD modification_date DATETIME NOT NULL, DROP orderNumber, DROP productId, DROP userId, DROP creationDate, DROP modificationDate');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE membership_order ADD orderNumber VARCHAR(255) NOT NULL, ADD productId INT NOT NULL, ADD userId INT NOT NULL, ADD creationDate DATETIME NOT NULL, ADD modificationDate DATETIME NOT NULL, DROP card_id, DROP order_number, DROP user_id, DROP valid_period, DROP specification, DROP status, DROP pay_channel, DROP payment_date, DROP cancelled_date, DROP invoiced, DROP sales_invoice, DROP service_fee, DROP creation_date, DROP modification_date');
    }
}
